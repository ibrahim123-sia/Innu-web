...
const Analytics = () => {
  ...
  useEffect(() => {
    if (allOrders && filteredShops.length > 0) {
      ...
      const districtOrders = allOrders.filter(order => shopIds.includes(order.shop_id));
      setFilteredOrders(districtOrders);
    }
  ...
  const fetchData = async () => {
    ...
    try {
      await Promise.all([
        dispatch(getDistrictShops(districtId)), // Pass districtId
    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-4 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex items-end">
            <button
              onClick={fetchData}
              className="w-full bg-primary-blue hover:bg-primary-blue-dark text-white py-2 px-4 rounded-lg transition-colors flex items-center justify-center"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-primary-blue-50 rounded-lg p-6 border border-primary-blue-100">
          <h3 className="text-sm font-medium text-primary-blue-600 mb-2">Total Video Requests</h3>
          <p className="text-2xl font-bold text-primary-blue-700">{districtTotals.totalVideosInDistrict}</p>
          <p className="text-sm text-primary-blue-600 mt-1">Videos processed in district</p>
        </div>
        ...
        <div className="bg-primary-red-50 rounded-lg p-6 border border-primary-red-100">
          <h3 className="text-sm font-medium text-primary-red-600 mb-2">Failed Videos</h3>
          <p className="text-2xl font-bold text-primary-red-700">{districtTotals.totalFailedVideos}</p>
          <p className="text-sm text-primary-red-600 mt-1">Videos that failed to process</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-primary-blue-100 rounded-lg">
            <div className="text-2xl font-bold text-primary-blue-600">{districtTotals.totalUploadedVideos || 0}</div>
          ...
          <div className="text-center p-4 bg-primary-red-100 rounded-lg">
            <div className="text-2xl font-bold text-primary-red-600">{districtTotals.totalFailedVideos || 0}</div>
                    ...
                    <td className="px-6 py-4">
                      <div className="space-y-2">
                        <div className="flex items-center space-x-2">
                          ...
                          <div>
                            <div className="text-lg font-bold text-primary-blue-600">{shop.totalVideoRequests || 0}</div>
                    ...
                    <td className="px-6 py-4">
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-medium text-primary-red-600">{shop.failedVideos || 0}</span>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-medium text-primary-red-600">{shop.errorRate || "0.0"}%</span>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <div className="bg-primary-blue-50 p-4 rounded-lg border border-primary-blue-100">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="text-sm font-medium text-primary-blue-600">Total Video Requests</h4>
                      <p className="text-2xl font-bold text-primary-blue-700 mt-1">{shopAnalyticsData.totalVideoRequests}</p>
                      <p className="text-xs text-primary-blue-500">Total videos for this shop</p>
                    </div>
                    <div className="w-10 h-10 bg-primary-blue-100 rounded-full flex items-center justify-center">
                      <svg className="w-6 h-6 text-primary-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                      </svg>
                    </div>
                  </div>
                ...
                <div className="bg-primary-red-50 p-4 rounded-lg border border-primary-red-100">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="text-sm font-medium text-primary-red-600">Failed Videos</h4>
                      <p className="text-2xl font-bold text-primary-red-700 mt-1">{shopAnalyticsData.failedVideos}</p>
                      <p className="text-xs text-primary-red-500">Videos that failed to process</p>
                    </div>
                    <div className="w-10 h-10 bg-primary-red-100 rounded-full flex items-center justify-center">
                      <svg className="w-6 h-6 text-primary-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-primary-blue-50 rounded-lg">
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-sm font-medium text-primary-blue-700">Uploaded Videos</span>
                        <span className="text-lg font-bold text-primary-blue-700">{shopAnalyticsData.uploadedVideos}</span>
                      </div>
                      <p className="text-xs text-primary-blue-500">Videos uploaded but not yet processed</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-white border rounded-lg">
                      ...
                      <div className="mt-4 flex items-center justify-between text-sm">
                        ...
                        <div className="flex items-center">
                          <div className="w-3 h-3 bg-primary-red-500 rounded-full mr-2"></div>
